...
export class CubismMoc {
  private static resolveMocVersion(
    moc: Live2DCubismCore.Moc | null,
    mocBytes: ArrayBuffer
  ): number {
    const versionApi = Live2DCubismCore.Version as unknown as {
    ...
    if (moc) {
      try {
        ...
        // 兼容旧版 Core：csmGetMocVersion 仅接受 mocBytes 单参数。
      }
    }
  ...
  public static create(
    ...
    if (moc) {
      ...
      cubismMoc._mocVersion = CubismMoc.resolveMocVersion(moc, mocBytes);
    }
